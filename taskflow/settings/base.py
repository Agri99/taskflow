...
# SECRET_KEY = 'django-insecure-yba^ztl_06k3g69fd$8(i59hy(y32gb3n=d$#o1txnlg-2w^qe'
...
SIMPLE_JWT = {
    ...
    'SIGNING_KEY': os.getenv('DJANGO_SECRET_KEY', 'unsafe-secret-key-that-is-long-enough-for-jwt'),
}
